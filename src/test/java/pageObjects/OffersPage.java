...
public class OffersPage extends BasePage {
	...
	@FindBy(xpath = "//div[contains(@class, 'dp__cell') and text()='5']")
	WebElement selectSDate;

	// Only End Date Select
	@FindBy(xpath = "//div[contains(@class, 'dp__cell') and text()='29']")
	...
	public void selectFileUpload() {
		...
		String imagePath = "C:\\Users\\Tahamidul\\Downloads\\selenium\\demopngtest.png";
	...
	public String getTextNameOffer() {
		return wait.until(
	...
	public String getTextNameOfferEdit() {
		return wait
